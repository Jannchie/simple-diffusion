...
legacy_preprocessors = {
    ...
    "depth_zoe": {"label": "depth_zoe", "call_function": zoe_depth, "unload_function": unload_zoe_depth, "managed_model": "model_zoe_depth", "model_free": False, "no_control_mode": False, "resolution": None, "slider_1": None, "slider_2": None, "slider_3": None, "priority": 0, "tags": ["Depth"]},
    "dw_openpose_full": {
    ...
    "mlsd": {
        ...
        "no_control_mode": False,
        "resolution": {"label": "Resolution", "minimum": 64, "maximum": 2048, "value": 512},
        "slider_1": {"label": "MLSD Value Threshold", "minimum": 0.01, "maximum": 2.0, "value": 0.1, "step": 0.01},
        "slider_2": {"label": "MLSD Distance Threshold", "minimum": 0.01, "maximum": 20.0, "value": 0.1, "step": 0.01},
        "slider_3": None,
        "priority": 100,
        "tags": ["MLSD"],
    ...
    "shuffle": {"label": "shuffle", "call_function": shuffle, "unload_function": None, "managed_model": None, "model_free": False, "no_control_mode": False, "resolution": None, "slider_1": None, "slider_2": None, "slider_3": None, "priority": 100, "tags": ["Shuffle"]},
    "softedge_hed": {
        "label": "softedge_hed",
        "call_function": hed,
