...
def write_loss(log_directory, filename, step, epoch_len, values):
    ...
    with open(os.path.join(log_directory, filename), "a+", newline="") as fout:
        ...
        csv_writer.writerow(
            {"step": step, "epoch": epoch, "epoch_step": epoch_step, **values,}
        )
...
def tensorboard_setup(log_directory):
    ...
    return SummaryWriter(log_dir=os.path.join(log_directory, "tensorboard"), flush_secs=shared.opts.training_tensorboard_flush_every)
        ...
        for _ in range((steps - initial_step) * gradient_step):
            ...
            for j, batch in enumerate(dl):
                ...
                if images_dir is not None and steps_done % create_image_every == 0:
                    ...
                    p = processing.StableDiffusionProcessingTxt2Img(sd_model=shared.sd_model, do_not_save_grid=True, do_not_save_samples=True, do_not_reload_embeddings=True,)
