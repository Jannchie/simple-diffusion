...
class Api:
    ...
    def text2imgapi(self, txt2imgreq: models.StableDiffusionTxt2ImgProcessingAPI):
        ...
        populate = txt2imgreq.copy(update={"sampler_name": validate_sampler_name(txt2imgreq.sampler_name or txt2imgreq.sampler_index), "do_not_save_samples": not txt2imgreq.save_images, "do_not_save_grid": not txt2imgreq.save_images,})  # Override __init__ params
    ...
    def img2imgapi(self, img2imgreq: models.StableDiffusionImg2ImgProcessingAPI):
        ...
        populate = img2imgreq.copy(update={"sampler_name": validate_sampler_name(img2imgreq.sampler_name or img2imgreq.sampler_index), "do_not_save_samples": not img2imgreq.save_images, "do_not_save_grid": not img2imgreq.save_images, "mask": mask,})  # Override __init__ params
        if populate.sampler_name:
            populate.sampler_index = None  # prevent a warning later on
    ...
    def get_latent_upscale_modes(self):
        return [{"name": upscale_mode,} for upscale_mode in [*(shared.latent_upscale_modes or {})]]
