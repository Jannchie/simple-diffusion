...
event_subscriber_map = dict(callbacks_setting_updated=[],)
...
def setting_updated_event_subscriber_chain(handler, component, setting_name: str):
    ...
    for param in event_subscriber_map["callbacks_setting_updated"]:
        handler = handler.then(fn=lambda *args: param["fn"](*args, setting_name), inputs=param["inputs"] + [component], outputs=param["outputs"], show_progress=False,)
