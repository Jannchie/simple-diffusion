...
class Toprow:
    ...
    def create_prompts(self):
        ...
        self.prompt_img.change(
            fn=modules.images.image_data, inputs=[self.prompt_img], outputs=[self.prompt, self.prompt_img], show_progress=False,
        )
    ...
    def create_tools_row(self):
        with gr.Row(elem_id=f"{self.id_part}_tools"):
            ...
            self.clear_prompt_button.click(
                fn=lambda *x: x, _js="confirm_clear_prompt", inputs=[self.prompt, self.negative_prompt], outputs=[self.prompt, self.negative_prompt],
            )
