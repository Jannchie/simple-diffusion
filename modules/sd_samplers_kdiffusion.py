...
k_diffusion_scheduler = {"Automatic": None, "karras": k_diffusion.sampling.get_sigmas_karras, "exponential": k_diffusion.sampling.get_sigmas_exponential, "polyexponential": k_diffusion.sampling.get_sigmas_polyexponential}
...
class KDiffusionSampler(sd_samplers_common.Sampler):
    ...
    def sample_img2img(self, p, x, noise, conditioning, unconditional_conditioning, steps=None, image_conditioning=None):
        ...
        self.last_latent = x
        self.sampler_extra_args = {"cond": conditioning, "image_cond": image_conditioning, "uncond": unconditional_conditioning, "cond_scale": p.cfg_scale, "s_min_uncond": self.s_min_uncond}
