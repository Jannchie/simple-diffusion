...
sd_configs_path = os.path.join(script_path, "configs", "webui")
...
parser_pre.add_argument(
    "--data-dir", type=str, default=os.path.dirname(modules_path), help="base path where all user data is stored",
)
