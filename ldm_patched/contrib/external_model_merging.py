...
class CheckpointSave:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {"model": ("MODEL",), "clip": ("CLIP",), "vae": ("VAE",), "filename_prefix": ("STRING", {"default": "checkpoints/ldm_patched"}),},
...
class CLIPSave:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {"clip": ("CLIP",), "filename_prefix": ("STRING", {"default": "clip/ldm_patched"}),},
            "hidden": {"prompt": "PROMPT", "extra_pnginfo": "EXTRA_PNGINFO"},
        }
...
class VAESave:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {"vae": ("VAE",), "filename_prefix": ("STRING", {"default": "vae/ldm_patched_vae"}),},
            "hidden": {"prompt": "PROMPT", "extra_pnginfo": "EXTRA_PNGINFO"},
        }
