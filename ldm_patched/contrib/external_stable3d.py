...
def camera_embeddings(elevation, azimuth):
    ...
    embeddings = torch.stack([torch.deg2rad((90 - elevation) - (90)), torch.sin(torch.deg2rad(azimuth)), torch.cos(torch.deg2rad(azimuth)), torch.deg2rad(90 - torch.full_like(elevation, 0)),], dim=-1).unsqueeze(1)  # Zero123 polar is 90-elevation
