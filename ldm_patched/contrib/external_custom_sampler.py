...
class BasicScheduler:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {"model": ("MODEL",), "scheduler": (ldm_patched.modules.samplers.SCHEDULER_NAMES,), "steps": ("INT", {"default": 20, "min": 1, "max": 10000}), "denoise": ("FLOAT", {"default": 1.0, "min": 0.0, "max": 1.0, "step": 0.01}),}}
...
class KSamplerSelect:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {"sampler_name": (ldm_patched.modules.samplers.SAMPLER_NAMES,),}}
