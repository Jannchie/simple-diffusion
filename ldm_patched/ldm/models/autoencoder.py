...
class AbstractAutoencoder(torch.nn.Module):
    ...
    def __init__(
        self, ema_decay: Union[None, float] = None, monitor: Union[None, str] = None, input_key: str = "jpg", **kwargs,
    ):
        super().__init__()
...
class AutoencodingEngine(AbstractAutoencoder):
    ...
    def __init__(
        self, *args, encoder_config: Dict, decoder_config: Dict, regularizer_config: Dict, **kwargs,
    ):
    ...
    def encode(self, x: torch.Tensor, return_reg_log: bool = False, unregularized: bool = False,) -> Union[torch.Tensor, Tuple[torch.Tensor, dict]]:
        z = self.encoder(x)
        if unregularized:
            return z, dict()
...
class AutoencodingEngineLegacy(AutoencodingEngine):
    def __init__(self, embed_dim: int, **kwargs):
        ...
        super().__init__(
            encoder_config={"target": "ldm_patched.ldm.modules.diffusionmodules.model.Encoder", "params": ddconfig,}, decoder_config={"target": "ldm_patched.ldm.modules.diffusionmodules.model.Decoder", "params": ddconfig,}, **kwargs,
        )
        self.quant_conv = ldm_patched.modules.ops.disable_weight_init.Conv2d((1 + ddconfig["double_z"]) * ddconfig["z_channels"], (1 + ddconfig["double_z"]) * embed_dim, 1,)
...
class AutoencoderKL(AutoencodingEngineLegacy):
    def __init__(self, **kwargs):
        ...
        super().__init__(
            regularizer_config={"target": ("ldm_patched.ldm.models.autoencoder.DiagonalGaussianRegularizer")}, **kwargs,
        )
