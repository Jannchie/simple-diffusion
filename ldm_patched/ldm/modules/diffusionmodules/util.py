...
class AlphaBlender(nn.Module):
    ...
    def __init__(
        self, alpha: float, merge_strategy: str = "learned_with_images", rearrange_pattern: str = "b t -> (b t) 1 1",
    ):
        super().__init__()
    ...
    def get_alpha(self, image_only_indicator: torch.Tensor) -> torch.Tensor:
        ...
        if self.merge_strategy == "fixed":
            ...
            alpha = torch.where(image_only_indicator.bool(), torch.ones(1, 1, device=image_only_indicator.device), rearrange(torch.sigmoid(self.mix_factor.to(image_only_indicator.device)), "... -> ... 1"),)
