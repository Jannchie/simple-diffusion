...
class AbstractLowScaleModel(nn.Module):
    ...
    def q_sample(self, x_start, t, noise=None, seed=None):
        ...
        return extract_into_tensor(self.sqrt_alphas_cumprod.to(x_start.device), t, x_start.shape) * x_start + extract_into_tensor(self.sqrt_one_minus_alphas_cumprod.to(x_start.device), t, x_start.shape) * noise
