...
class ConvTransBlock(nn.Module):
    def __init__(
        self, conv_dim, trans_dim, head_dim, window_size, drop_path, type="W", input_resolution=None,
    ):
...
class SCUNet(nn.Module):
    def __init__(
        self, state_dict, in_nc=3, config=[4, 4, 4, 4, 4, 4, 4], dim=64, drop_path_rate=0.0, input_resolution=256,
    ):
