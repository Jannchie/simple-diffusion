...
class EqualLinear(nn.Module):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(in_channels={self.in_channels}, " f"out_channels={self.out_channels}, bias={self.bias is not None})"
...
class ModulatedConv2d(nn.Module):
    ...
    def __init__(
        self, in_channels, out_channels, kernel_size, num_style_feat, demodulate=True, sample_mode=None, eps=1e-8, interpolation_mode="bilinear",
    ):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(in_channels={self.in_channels}, " f"out_channels={self.out_channels}, " f"kernel_size={self.kernel_size}, " f"demodulate={self.demodulate}, sample_mode={self.sample_mode})"
...
class StyleConv(nn.Module):
    ...
    def __init__(
        self, in_channels, out_channels, kernel_size, num_style_feat, demodulate=True, sample_mode=None, interpolation_mode="bilinear",
    ):
...
class StyleGAN2GeneratorBilinear(nn.Module):
    ...
    def forward(
        self, styles, input_is_latent=False, noise=None, randomize_noise=True, truncation=1, truncation_latent=None, inject_index=None, return_latents=False,
    ):
...
class EqualConv2d(nn.Module):
    ...
    def __repr__(self):
        return f"{self.__class__.__name__}(in_channels={self.in_channels}, " f"out_channels={self.out_channels}, " f"kernel_size={self.kernel_size}," f" stride={self.stride}, padding={self.padding}, " f"bias={self.bias is not None})"
