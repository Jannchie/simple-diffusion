...
def load_config(file):
    defaults = {
        "model": {"sigma_data": 1.0, "patch_size": 1, "dropout_rate": 0.0, "augment_wrapper": True, "augment_prob": 0.0, "mapping_cond_dim": 0, "unet_cond_dim": 0, "cross_cond_dim": 0, "cross_attn_depths": None, "skip_stages": 0, "has_variance": False, "loss_config": "karras",},
        "dataset": {"type": "imagefolder",},
        "optimizer": {"type": "adamw", "lr": 1e-4, "betas": [0.95, 0.999], "eps": 1e-6, "weight_decay": 1e-3,},
